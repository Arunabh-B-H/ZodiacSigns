        ...
        >
          <div className="founders-text">
            ...
            <p className="founders-description">
              Our journey began half a century ago under the visionary leadership of our founders.
              With a passion for art and an eye for innovation, they transformed a humble workshop
              in Karunagappally into the region's premier destination for high-quality signage.
            </p>
            <p className="founders-description">
              Their commitment to excellence, integrity, and customer satisfaction remains the
              cornerstone of Zodiac Signs. Today, we continue to honor their legacy by integrating
